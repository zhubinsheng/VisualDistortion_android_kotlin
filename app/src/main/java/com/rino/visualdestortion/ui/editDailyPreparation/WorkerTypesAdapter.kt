...
class WorkerTypesAdapter(private var itemsList: ArrayList<PrepWorkers>, private var viewModel: EditDailyPViewModel, private  var context: Context) :
    ...
    fun updateItems(newFavoriteList: List<PrepWorkers>) {
        itemsList.clear()
